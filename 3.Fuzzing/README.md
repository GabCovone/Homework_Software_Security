...
## 3.1 Fuzz OpenSSLL with AFL and ASAN
...
```Bash
Bashopenssl req -x509 -newkey rsa:512 -keyout server.key -out server.pem -days 365 -nodes -subj /CN=a/
```
...
## 3.2 Riproduzione Heartbleed e diagnosi
...
eseguendo hexdump 
```shell
-C output/default/crashes/id:000000,sig:06,src:000030+000023,time:711360,execs:109670,op:splice,rep:2 otteniamo il seguente output:
...
## 3.4 Analisi programma con Valgrind
...
## 3.4 Eseguire AFL con ottimizzazioni di performance
